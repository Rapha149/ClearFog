...
public class Wrapper1_20_R1 implements VersionWrapper {
    ...
    public Object replaceViewDistance(Object obj, int viewDistance) {
        if (obj instanceof PacketPlayOutLogin packet) {
            return new PacketPlayOutLogin(packet.a(), packet.c(), packet.d(), packet.e(), packet.f(), packet.g(),
                    packet.h(), packet.i(), packet.j(), packet.k(), viewDistance, packet.m(), packet.n(), packet.o(),
                    packet.p(), packet.q(), packet.r(), packet.s());
    ...
    public void updateViewDistance(Player player, int viewDistance, boolean directUpdate) {
        ...
        p.c.a(new PacketPlayOutViewDistance(viewDistance));
